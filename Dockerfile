...
COPY --from=build /go/src/cs-cloudflare-worker-bouncer/config/crowdsec-cloudflare-bouncer-docker.yaml /etc/crowdsec/bouncers/crowdsec-cloudflare-worker-bouncer.yaml

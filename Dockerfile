...
COPY --from=build /go/src/cs-cloudflare-worker-bouncer/config/crowdsec-cloudflare-worker-bouncer_docker.yaml /etc/crowdsec/bouncers/crowdsec-cloudflare-worker-bouncer.yaml
